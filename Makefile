...
lint:  ## run python linter with ruff
	python -m ruff check artlink
	python -m ruff format --check artlink

# Alias
lints: lint

fix:  ## fix python formatting with ruff
	python -m ruff check --fix artlink
	python -m ruff format artlink
...
test:  ## run python tests
	python -m pytest -v artlink/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v artlink/tests --cov=artlink --cov-report term-missing --cov-report xml
